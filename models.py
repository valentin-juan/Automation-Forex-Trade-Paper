...
def statement_from_json(json):
    return Statement(
        json["date"],
        json["business_expenses"],
        json["income"],
        json["ending_balance_mounth"],
...
class Statement:
    def __init__ (self, date, business_expenses, income, ending_balance_month, ending_balance_total, tax_paid, withdrew, salary, errors):
        self.date = date
        self.buisiness_expenses = business_expenses
        self.income = income
